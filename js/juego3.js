...
function hablarInstrucciones(){
    ...
    mensaje.text =
    "Bienvenido al juego de multiplicaciones. Arrastra los números correctos a las casillas vacías para completar las operaciones matemáticas. Luego presiona el botón verificar.";
...
verificarBtn.addEventListener('click', ()=>{
    ...
    if(correctas === zonas.length){
        ...
        // GUARDAR PUNTAJE
        localStorage.setItem("puntajeJuego3", score);
